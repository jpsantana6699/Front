...
function alterarContexto(contexto) {
    ...
    switch (contexto) {
        ...
        case "descanso-curto":
            titulo.innerHTML = `
            Hora de trabalhar a movimentação! <strong class="app__title-strong">Pratique seus deslocamentos.</strong>
            ` 
            break;
        case "descanso-longo":
            titulo.innerHTML = `
            Momento de aprimorar o controle.<strong class="app__title-strong"> Domine suas habilidades.</strong>
            `
        default:
            break;
    }
